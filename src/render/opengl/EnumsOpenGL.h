...
static inline math::float4 cvtBorderColor(BorderColor color) {
  switch (color) {
    case Border_BLACK:          return math::float4(0.f);
    case Border_WHITE:          return math::float4(1.f);
    default:
      break;
  }
  return math::float4(0.f);
}
